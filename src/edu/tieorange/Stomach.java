...
public class Stomach extends Organ {
    public Stomach(List<String> sounds, String surname, int caloriesConsumptionPerMinute, int minimalCaloriesConsumption, String name) {
    ...
    public void BroadcastYourFunction(Organ otherOrgan) {
        ...
        System.out.println("Yo " + otherOrganName + " " + otherOrgan.Name + "my job is to DIGEST FOOOOOOD, you know what I mean? mm?");
    }
}
